...
BEGIN
SET DATEFORMAT ymd;
DECLARE @Id_TipoCambio	int = (SELECT ct.Id_TipoCambio FROM dbo.CAJ_TIPOCAMBIO ct WHERE ct.FechaHora=CONVERT(DATETIME, @FechaHora,121) AND ct.Cod_Moneda=@Cod_Moneda)
