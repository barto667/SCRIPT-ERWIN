...
DECLARE @id_comprobante int,@Referenciados varchar(MAX)
...
BEGIN
  ...
  INSERT INTO #tempTablaResultado
           ...
           SELECT DISTINCT
            '23',
            'Comprobante referenciado por multiples notas de credito de anulacion en los ultimos 7 dias',
             @id_comprobante,
            CONCAT(@Cod_Tipocomprobante,
          '|', @Serie +'-'+@Numero , '|','REFERENCIAS : ' + @Referenciados,'|',CONVERT(varchar,@fecha))
